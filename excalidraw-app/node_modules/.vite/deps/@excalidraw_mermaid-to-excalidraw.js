...
import {
  selectSvgElement
} from "./chunk-KCRJQ5O3.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-XFIW7ERP.js";
import {
  registerLayoutLoaders
} from "./chunk-P4UL4DCE.js";
import "./chunk-3KXJXV3K.js";
import "./chunk-UMQBKR2A.js";
import "./chunk-FUOBCFCI.js";
import "./chunk-NCRUKGWY.js";
import "./chunk-K4HO3NBF.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-KVEIN3XW.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-QFMSVGTJ.js";
import "./chunk-STZ5W2IF.js";
import {
  UnknownDiagramError,
  addDirective,
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-55OO3MZR.js";
import {
  isEmpty_default
} from "./chunk-3VUBLR4B.js";
import "./chunk-3ZHRBJPO.js";
import {
  __name,
  log,
  select_default,
  setLogLevel
} from "./chunk-J3TDWMLL.js";
import {
  __commonJS,
  __toESM
} from "./chunk-M3FCBBX7.js";
...
var computeGroupIds = (graph) => {
  ...
  const mapper = {};
  [...Object.keys(graph.vertices), ...graph.subGraphs.map((c) => c.id)].forEach((id28) => {
    if (!tree[id28]) {
      return;
    }
    let curr = tree[id28];
...
var nanoid = (size = 21) => crypto.getRandomValues(new Uint8Array(size)).reduce((id28, byte) => {
  byte &= 63;
  if (byte < 36) {
    id28 += byte.toString(36);
  } else if (byte < 62) {
    id28 += (byte - 26).toString(36).toUpperCase();
  } else if (byte > 62) {
    id28 += "-";
  } else {
    id28 += "_";
      ...
      chart.groups.forEach((group) => {
        ...
        const actors = elements.filter((ele) => {
          if (ele.id) {
            ...
            const id28 = ele.id.substring(0, hyphenIndex);
            return actorKeys.includes(id28);
          }
          return false;
        });
        if (!actors.length) {
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-YG6GDRKO-PHBZE62W.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-NV44I4VS-HNFHJCXT.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q2GNP2WA-ASE3TJOQ.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NY62KEGX-NW7PIJSF.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-JELNMOA3-EZIIQ4NZ.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-WHAUD3N6-IHQNMAPT.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ADFJNKIX-2RDQ5NQO.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-AYHSOK5B-AHGDOMQS.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-PRI3JC2R-36MGHFRR.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-UZGBJVZJ-TJK7R4MF.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WL72ISMW-GJC6AMQR.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-2ON5EDUG-AMIZGDM2.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-WZHVMYZB-ROMWY32M.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-FKZM4ZOC-IEAQIWYU.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4FDKWEC3-K3PMMN7E.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-XKPGCS4Q-I6KGVTJP.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-IT6M3QCI-JPT7YGN2.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-VGOIOE7T-5LCZ3SJC.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-3W4ZIXB7-S7WOS6T2.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-TZEHDZUN-VZCHWI2G.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S2PKOQOG-IOLCDRCC.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QEK2KX5R-7LIK2L2P.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-VD42YOAC-MN2AHXWY.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-VXUJARFQ-NPGG5OXM.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-PSM6KHXK-BHAM6BSP.js");
...
var parseMermaidFlowChartDiagram = (db, containerEl) => {
  ...
  if (verticesData instanceof Map) {
    verticesData.forEach((vertex, id28) => {
      vertices[id28] = parseVertex(vertex, containerEl, normalizedClasses);
    });
  } else if (typeof verticesData === "object" && verticesData !== null) {
    Object.entries(verticesData).forEach(([id28, vertex]) => {
      vertices[id28] = parseVertex(vertex, containerEl, normalizedClasses);
    });
  }
...
var createContainerSkeletonFromSVG = (node2, type, opts = {}) => {
  const container = {};
  container.type = type;
  const { label, subtype, id: id28, groupId } = opts;
  container.id = id28;
  if (groupId) {
...
var createActorSymbol = (rootNode, text, opts) => {
  ...
  children.forEach((child, index) => {
    const id28 = `${opts == null ? void 0 : opts.id}-${index}`;
    let ele;
    switch (child.tagName) {
      case "line":
        ...
        ele = createLineSkeletonFromSVG(child, startX, startY, endX, endY, { groupId, id: id28 });
        break;
      case "text":
...
var parseClasses = (classes, containerEl, lookUpDomId) => {
  ...
  Object.values(classes).forEach((classNode) => {
    ...
    const findByPrefix = (id28) => {
      const regex = new RegExp(`^classId-${id28}(?:-|$)`);
...
var parseRelations = (relations, classNodes, containerEl, direction) => {
  ...
  relations.forEach((relationNode) => {
    const { id1, id2: id28, relation } = relationNode;
    const node1 = classNodes.find((node3) => node3.id === id1);
    const node2 = classNodes.find((node3) => node3.id === id28);
    if (!node1) {
      throw new Error(`parseRelations: Cannot find node with id ${id1}`);
    }
    if (!node2) {
      throw new Error(`parseRelations: Cannot find node with id ${id28}`);
    }
    ...
    if (id1 === id28) {
      ...
      if (!edgePaths.length) {
        throw new Error(`parseRelations: Cannot find rendered SVG edge for relation ${id1} -> ${id28}`);
      }
...
var parseNotes = (notes, containerEl, classNodes) => {
  ...
  notes.forEach((note, index) => {
    const { id: id28, text, class: classId } = note;
    const node2 = containerEl.querySelector(`#${id28}`);
    if (!node2) {
      throw new Error(`Node with id ${id28} not found!`);
    }
